...
public class SocialUtils {
    ...
    public static byte[] getHtmlByteArray(final String url) {
        try {
            Bitmap bitmap = Glide.with(UtilsCode.INSTANCE.getTopActivity()).asBitmap().load(url).submit().get();
    ...
    public static Bitmap getHtmlBitmap(final String url) {
        try {
            return Glide.with(UtilsCode.INSTANCE.getTopActivity()).asBitmap().load(url).submit().get();
        } catch (ExecutionException e) {
            e.printStackTrace();
        } catch (InterruptedException e) {
            e.printStackTrace();
