...
public class SessionPanel extends RelativeLayout implements ISessionPanel {
    ...
    /**
     * 会话List可接收的事件(除单击事件，单击事件参考{@link SessionClickListener})
     */
...
//        });
    ...
    /**
     * 设置会话面板的Listview的适配器{@link ISessionAdapter}
     *
     * @param adapter
     */
    @Override
    ...
    public void initDefault() {
        ...
        action.setActionClickListener(new PopActionClickListener() {
            ...
            public void onActionClick(int position, Object data) {
                if(mSessionClickListener!=null){
                    mSessionClickListener.onSessionDelete((SessionInfo) data);
                }
        ...
        sessionPopActions.add(action);
        setSessionPopActions(sessionPopActions, false);
