...
public class BaseUIKitConfigs<T> {
     ...
     */
    private static final int DEFAULT_MAX_INPUT_TEXT_LENGTH = 2048;
     ...
     * 服务端离线推送配置信息
     */
    private TIMOfflinePushSettings offlinePushSettings;
    ...
    public BaseUIKitConfigs setIMEventListener(com.tencent.qcloud.uikit.IMEventListener IMEventListener) {
        ...
        if(this.IMEventListener!=null){
            if(offlinePushSettings!=null){
                this.IMEventListener.onAddOfflineConfigSuccess(offlinePushSettings);
            }else{
                this.IMEventListener.onAddOfflineConfigError();
            }
        }
        return this;
    }

    public TIMOfflinePushSettings getOfflinePushSettings() {
        return offlinePushSettings;
    }

    public void setOfflinePushSettings(TIMOfflinePushSettings offlinePushSettings) {
        this.offlinePushSettings = offlinePushSettings;
    }
}
