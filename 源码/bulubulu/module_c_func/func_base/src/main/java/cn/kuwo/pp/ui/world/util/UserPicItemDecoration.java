...
public class UserPicItemDecoration extends RecyclerView.ItemDecoration {
    private Paint mPaint;
    private int mDividerWidth, mDividerHeight;

    public UserPicItemDecoration(int width, @ColorInt int color) {
        this(width, width, color);
    }

    public UserPicItemDecoration(int width, int height, @ColorInt int color) {
        mDividerWidth = width;
