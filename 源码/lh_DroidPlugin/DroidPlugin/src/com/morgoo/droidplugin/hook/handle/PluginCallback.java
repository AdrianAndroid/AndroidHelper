...
//    }
    ...
    private boolean handleLaunchActivity(Message msg) {
        try {
            Object obj = msg.obj;
            // 获取 ActivityClientRecord 对象中的 Intent（代理类的）
            ...
            if (targetIntent != null) {
                ...
                if (targetActivityInfo != null) {
                    ...
                    // 将系统中的 Intent（代理类的） 替换为插件类的 Intent
                    if (!success) {
