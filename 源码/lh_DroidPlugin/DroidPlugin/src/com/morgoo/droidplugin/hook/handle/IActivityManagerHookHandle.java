        ...
        protected void doReplaceIntentForStartActivityAPIHigh(Object[] args) throws RemoteException {
            ...
            if (args != null && args.length > 1 && intentOfArgIndex >= 0) {
                ...
                if (activityInfo != null && isPackagePlugin(activityInfo.packageName)) {
                    // 选择代理的Activity 并返回 ComponentName
                    //ComponentInfo{com.enjoy.lh_droidplugin/com.morgoo.droidplugin.stub.ActivityStub$P04$Standard00}
                    ComponentName component = selectProxyActivity(intent);
                    if (component != null) {
                        // 创建新的 Intent，用来做代理的 Intent
                        ...
                        try {
                            ...
                            Log.w(TAG, "Set Class LoadPluginProcessManagerer to new Intent fail", e);
                        }
