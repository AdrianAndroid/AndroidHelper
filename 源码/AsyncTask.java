...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private Result postResult(Result result) {
        ...
        message.sendToTarget(); // 发送一个Message
        return result;
    }
    ...
    private static class AsyncTaskResult<Data> { // 只简单的携带参数的对象
