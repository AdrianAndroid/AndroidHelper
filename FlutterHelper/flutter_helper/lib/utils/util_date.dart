...
// 这个月一共有几天， 1，2，5，7，8，10，腊，31天永不差
...
class DateUtil {
  ...
  static int getDateMsByTimeStr(String dateStr, {bool isUtc}) =>
      getDateTime(dateStr, isUtc: isUtc).millisecondsSinceEpoch;

  /// get Now Date Milliseconds.
  static int getNowDateMs() => DateTime.now().millisecondsSinceEpoch;

  /// get Now Date Str.(yyyy-MM-dd HH:mm:ss)
  static String getNowDateStr() => formatDate(DateTime.now());

  /// format date by milliseconds.
  /// milliseconds 日期毫秒
  static String formatDateMs(int ms, {bool isUtc = false, String format}) =>
      formatDate(getDateTimeByMs(ms, isUtc: isUtc), format: format);
  ...
  static String getWeekdayByMs(int milliseconds,
          ...
          bool short = false}) =>
      getWeekday(getDateTimeByMs(milliseconds, isUtc: isUtc),
