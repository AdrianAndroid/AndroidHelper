...
class SliverVariableSizeBoxAdaptorElement extends RenderObjectElement
  ...
  // We inf widgets at two different times:
  ...
  // so that if we do case 2 r, we don't call the builder again.
  ...
  Element updateChild(Element child, Widget newWidget, dynamic newSlot) {
    ...
    // set keepAlive to true in order to popu the cache
  ...
  double _extrapoMaxScrollOffset(
    int firstIndex,
    int lastIndex,
    double leadingScrollOffset,
    double trailingScrollOffset,
