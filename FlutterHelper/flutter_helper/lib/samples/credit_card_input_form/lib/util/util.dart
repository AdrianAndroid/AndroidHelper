...
final master = Image.asset('images/mastercard.png', width: 50);
final visa = Image.asset('images/visacard.png', width: 50);
final discover = Image.asset('images/discover.png', width: 50);

final amex = Image.asset('images/amex.png', width: 50);
