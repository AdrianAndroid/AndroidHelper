...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        detachAndScrapAttachedViews(recycler);  // --> TODO  回收
        ...
        if (mAnchorInfo.mLayoutFromEnd) {
            ...
            fill(recycler, mLayoutState, state, false); // --》 去查找缓存和复用的一种情况
    ...
    private void recycleChildren(RecyclerView.Recycler recycler, int startIndex, int endIndex) {
        ...
        if (endIndex > startIndex) {
            for (int i = endIndex - 1; i >= startIndex; i--) {
                removeAndRecycleViewAt(i, recycler);///////////////-》TODO
            }
        } else {
        ...
        if (mShouldReverseLayout) {
            for (int i = childCount - 1; i >= 0; i--) {
                ...
                if (mOrientationHelper.getDecoratedEnd(child) > limit
                    ...
                    // stop here
                    recycleChildren(recycler, childCount - 1, i);///////////////-》TODO
                    return;
                }
            }
        } else {
            for (int i = 0; i < childCount; i++) {
                ...
                if (mOrientationHelper.getDecoratedEnd(child) > limit
                        || mOrientationHelper.getTransformedEndWithDecoration(child) > limit) {
                    // stop here
                    recycleChildren(recycler, 0, i);///////////////-》TODO
                    return;
                }
            }
        }
    ...
    private void recycleByLayoutState(RecyclerView.Recycler recycler, LayoutState layoutState) {
        ...
        if (layoutState.mLayoutDirection == LayoutState.LAYOUT_START) {
            ...
            recycleViewsFromStart(recycler, scrollingOffset, noRecycleSpace); ///////////////-》TODO
        }
    }
    ...
    int fill(RecyclerView.Recycler recycler, LayoutState layoutState,
        ...
        if (layoutState.mScrollingOffset != LayoutState.SCROLLING_OFFSET_NaN) {
            ...
            recycleByLayoutState(recycler, layoutState); /////////////---》TODO 复用的情况
        }
        ...
        while ((layoutState.mInfinite || remainingSpace > 0) && layoutState.hasMore(state)) {
            ...
            layoutChunk(recycler, state, layoutState, layoutChunkResult);/////////////---》TODO
            if (RecyclerView.VERBOSE_TRACING) {
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        layoutDecoratedWithMargins(view, left, top, right, bottom); //真正的去复用
        if (DEBUG) {
