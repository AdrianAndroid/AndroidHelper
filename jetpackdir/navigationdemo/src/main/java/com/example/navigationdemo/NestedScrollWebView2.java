 ...
 * @author qjs
 */
public class NestedScrollWebView2 extends WebView implements NestedScrollingChild2 {

    private static final String TAG = NestedScrollWebView2.class.getSimpleName();
