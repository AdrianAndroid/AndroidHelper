...
public class SwipeBackLayout extends FrameLayout {
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            F.m(getClass(), "ViewDragCallback", "tryCaptureView");
        ...
        public int clampViewPositionHorizontal(View child, int left, int dx) {
            F.m(getClass(), "ViewDragCallback", "clampViewPositionHorizontal");
            int ret = 0;
            if ((mCurrentSwipeOrientation & EDGE_LEFT) != 0) {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            F.m(getClass(), "ViewDragCallback", "onViewPositionChanged");
        ...
        public int getViewHorizontalDragRange(View child) {
            F.m(getClass(), "ViewDragCallback", "getViewHorizontalDragRange");
            if (mFragment != null) {
                return 1;
            }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            F.m(getClass(), "ViewDragCallback", "onViewReleased");
        ...
        public void onViewDragStateChanged(int state) {
            ...
            F.m(getClass(), "ViewDragCallback", "onViewDragStateChanged");
            if (mListeners != null) {
                for (OnSwipeListener listener : mListeners) {
        ...
        public void onEdgeTouched(int edgeFlags, int pointerId) {
            ...
            F.m(getClass(), "ViewDragCallback", "onEdgeTouched");
