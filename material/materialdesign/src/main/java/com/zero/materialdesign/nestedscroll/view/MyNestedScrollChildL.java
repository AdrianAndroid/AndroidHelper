    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()){
            case MotionEvent.ACTION_DOWN:{
                ...
                int nestedScrollAxis = ViewCompat.SCROLL_AXIS_NONE; //会传到parent

                nestedScrollAxis |= ViewCompat.SCROLL_AXIS_HORIZONTAL;
                startNestedScroll(nestedScrollAxis); //会层层调用ParentHelper的onNestedScrollAccepted
                break;
            }
            case MotionEvent.ACTION_MOVE:{
                ...
                if(dispatchNestedPreScroll(dx,dy,consumed,null)){ //准备分发
