 ...
 * Description:
 */
public class CustomMethodVisitor2 extends AdviceAdapter {

    protected CustomMethodVisitor2(int api, MethodVisitor methodVisitor, int access, String name, String descriptor) {
